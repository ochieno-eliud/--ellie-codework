...
<body class="body"> 
	...
	<div class="content">
         ...
         <h1><a href="#" text="products">AGRICULTURAL EVENTS</a></h1>
	 </header>
      <ol>
         <?php
           echo"<li><a href='#'>Agricultural Shows</a></li><br><br>
           <li><a href='#'>Agricultural Seminars</a></li><br><br>
           <li><a href='#'>Farmers Training Centres Programs</a></li><br><br>
           <li><a href='#'>Agricultural Conferences</a></li>
           <br><br>";
           ?>
     </ol> 
   </div>
 ...
 echo" <p>He had known they were going to die for weeks. He could tell by the dullness
    ...
    <section class="Contacts">
	 ...
	 <div class="designer_info">
             <p><b>Designed by: </b><a href="#">BELDesigners</a></p>
	 </div> 
